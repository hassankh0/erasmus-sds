 ...
 {!edit && (
              <div>
                ...
                <div class="text-center flex justify-between">
                  ...
                  <div class="flex">
                    <button
                      class="bg-blue-500 text-white flex items-center active:bg-pink-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none mr-1 h-8 w-24 mt-4"
                      onClick={handleClick}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
            ...
            {edit && (
              <div>
                ...
                <div class="text-center flex justify-between">
                  ...
                  <div class="flex">
                  <button
                      class="bg-green-500 text-white flex items-center active:bg-pink-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none mr-1 h-8 w-24 mt-4"
                    >
                    ...
                    <button
                      class="bg-orange-500 text-white flex items-center active:bg-pink-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none mr-1 h-8 w-24 mt-4"
                      type="submit"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
