...
export default function CoursDetail() {
  ...
  const handleCommentDelete = async (commentId) => {
    await deleteComment(commentId).then(async () => {
      await fetchCourse();
    });
  };
      ...
      <Paper elevation={3} sx={{ p: 2 }}>
        ...
        >
          ...
          <Box sx={{ display: "flex", justifyContent: "center" }}>
            <Paper
              elevation={2}
              sx={{ width: "40%", margin: "0 10px", textAlign: "center" }}
            >
          ...
          <Collapse in={expanded} timeout="auto" unmountOnExit>
            <CardContent>
              ...
              <Typography paragraph>ECTS : {cours.credits}</Typography>
              <Typography paragraph>TEACHER : {cours.instructor}</Typography>
              {/* <Typography paragraph>
